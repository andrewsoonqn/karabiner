...
import { createHyperSubLayers, app, open, window, shell, shortcut } from "./utils";
...
const rules: KarabinerRules[] = [
    ...
    ...createHyperSubLayers({
        ...
        r: {
            ...
            i: open("raycast://extensions/raycast/emoji-symbols/search-emoji-symbols"), // i = "Icon" (Right Hand) - Moved from 'e'
            p: open("raycast://extensions/raycast/raycast/confetti"), // p = "Party" (Right Hand)
            h: open("raycast://extensions/raycast/clipboard-history/clipboard-history"), // h = History (Right Hand)
            l: open("raycast://extensions/cjdenio/two-factor-authentication-code-generator/index"), // l = "Login" (Right Hand) - Moved from 'a'
